// Package router YK-Platform API.
//
// golang server of platform
//
//     Schemes: http, https
...
import (
	"yk/internal/app/robot/router/handler"
...
func Register(engine *gin.Engine) {
	...
	// 长连接
	WebSocketGroup := engine.Group("/websockets")
	{
		WebSocketGroup.POST("/connections", handler.WebSocketHandler{}.Create)
	}
}
